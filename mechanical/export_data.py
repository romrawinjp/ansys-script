...
# Export Data
"""main solution for [Total Deformation, Total Acceleration, 
Total Velocity, Equivalent Elastic Strain, Elastic Strain Intensity, 
...
""" probes - all regional probes including force reaction, stress, strain, at tip, top, and skin."""
for analysis in Model.Analyses:
    Pane=ExtAPI.UserInterface.GetPane(MechanicalPanelEnum.TabularData)
    Con = Pane.ControlUnknown
